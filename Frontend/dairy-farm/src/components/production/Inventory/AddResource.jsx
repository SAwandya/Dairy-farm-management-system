...
function AddResource() {
  ...
  return (
    <div>
      <Button variant="contained" onClick={handleClickOpen}>Add Ingredient</Button>
      <Draggable>
        <Dialog
          open={open}
          onClose={handleClose}
          ...
          style={{ left: '45.5%', right: '10%', top: '8%' }}
        >
          <DialogTitle align="center">Add New Ingredient</DialogTitle>
          <DialogContent>
